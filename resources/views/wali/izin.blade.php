        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('wali.dashboard') ? 'active' : '' }}"
                            href="{{ route('wali.dashboard') }}">
                            <i class="bi bi-speedometer2"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('wali.izin') ? 'active' : '' }}"
                            href="{{ route('wali.izin') }}">
                            <i class="bi bi-envelope-paper"></i> Ajukan Izin
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('wali.izin.riwayat') ? 'active' : '' }}"
                            href="{{ route('wali.izin.riwayat') }}">
